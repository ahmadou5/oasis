    ...
    <div className="text-center space-y-12">
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <p className="text-xl text-gray-600 dark:text-solana-gray-300 max-w-2xl mx-auto leading-relaxed">
          Join thousands of SOL holders earning staking rewards on Solana's high-performance blockchain. 
          Secure, non-custodial, and optimized for maximum returns.
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
        {features.map((feature, index) => (
          <div key={index} className="card text-center group hover:scale-105 transition-transform duration-200">
            ...
            <p className="text-gray-500 dark:text-solana-gray-400">{feature.description}</p>
          </div>
        ))}
      </div>
      ...
      <div className="bg-gradient-to-r from-solana-purple/10 to-solana-green/10 dark:from-solana-purple/20 dark:to-solana-green/20 rounded-2xl p-8 border border-solana-purple/20 dark:border-solana-purple/30">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <div className="text-gray-500 dark:text-solana-gray-400 mt-1">Active Validators</div>
          </div>
          <div className="text-center">
