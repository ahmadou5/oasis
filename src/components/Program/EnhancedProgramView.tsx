...
export function EnhancedProgramView({ data }: EnhancedProgramViewProps) {
  ...
  const isImmutable = !data.owner || data.executable;
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {isImmutable && (
              <div className="flex items-center gap-2 px-3 py-2 bg-green-900/20 border border-green-800/50 rounded-lg">
                ...
                <span className="text-green-400 text-sm font-medium">Immutable</span>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          {activeTab === "history" && (
            <HistoryTab data={data} hideSpam={hideSpam} setHideSpam={setHideSpam} />
          )}
          {activeTab === "idl" && (
            <IDLTab data={data} expanded={expandedSections} toggleSection={toggleSection} />
          )}
          ...
          {activeTab === "security" && (
            <SecurityTab data={data} expanded={expandedSections} toggleSection={toggleSection} />
          )}
          {activeTab === "authority" && (
            <AuthorityTab
              data={data}
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`px-2 py-1 rounded text-xs ${
              hideSpam ? "bg-red-900/30 text-red-400" : "bg-gray-800 text-gray-400"
            }`}
          >
            Hide spam
          </button>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-800">
                <th className="text-left pb-3 text-gray-500 text-xs uppercase font-medium">Type</th>
                <th className="text-left pb-3 text-gray-500 text-xs uppercase font-medium">Time</th>
                <th className="text-left pb-3 text-gray-500 text-xs uppercase font-medium">Signature</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div>
          ...
          <div className="bg-[#0d0d0d] border border-red-900/30 rounded-xl p-12 text-center mb-6">
            ...
            <p className="text-gray-400 mb-4 max-w-md mx-auto">
              The Anchor IDL for this program is not available or could not be retrieved.
            </p>
            <div className="text-left max-w-md mx-auto">
              <div className="text-red-400 text-sm font-semibold mb-2">Possible Reasons:</div>
          ...
          >
            <div className="space-y-4 text-gray-300">
              <p>
                An IDL (Interface Definition Language) is a JSON file that describes the structure,
                instructions, and data types of an Anchor smart contract on Solana.
              </p>
              <div>
                <h5 className="text-red-400 font-semibold mb-2">KEY COMPONENTS:</h5>
                <ul className="space-y-2 list-disc list-inside">
                  <li>
                    <strong>Instructions:</strong> Available functions that can be called on the program
                  </li>
                  <li>
                    <strong>Accounts:</strong> Account structures and their validation rules
                  </li>
                  <li>
                    <strong>Types:</strong> Custom data structures used by the program
                  </li>
                  <li>
                    <strong>Events:</strong> Events emitted by the program for off-chain tracking
                  </li>
                  <li>
              ...
              <div>
                <h5 className="text-red-400 font-semibold mb-2">WHY IS THIS IMPORTANT?</h5>
                <p>
                  IDLs enable developers to interact with smart contracts programmatically, generate client
                  libraries automatically, and understand the program's interface without reading the source code.
                </p>
              </div>
            </div>
          </ExpandableSection>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-white text-lg font-semibold">Program Verification</h3>
        <button
      ...
      <div className="bg-[#0d0d0d] border border-gray-800 rounded-xl divide-y divide-gray-800">
        <InfoRow label="Status" value={isVerified ? "Verified" : "Unverified"} />
      ...
      <div className="mt-6">
        ...
        >
          <div className="space-y-4 text-gray-300">
            <p>
              Program verification allows developers to prove that the on-chain bytecode matches the
              published source code, increasing transparency and trust.
            </p>
            <p>
              An unverified program means the bytecode cannot be independently verified against source code,
              which doesn't necessarily mean it's malicious, but users should exercise additional caution.
            </p>
            <div>
              <h5 className="text-red-400 font-semibold mb-2">VERIFICATION BENEFITS:</h5>
      ...
      {!hasSecurityTxt && (
        <div>
          ...
          <div className="bg-[#0d0d0d] border border-red-900/30 rounded-xl p-12 text-center mb-6">
            ...
            <h4 className="text-2xl font-bold text-white mb-2">NO SECURITY.TXT FOUND</h4>
            <p className="text-gray-400 mb-4 max-w-md mx-auto">
              The security.txt for this program is not available or could not be retrieved.
            </p>
            <div className="text-left max-w-md mx-auto">
              <div className="text-red-400 text-sm font-semibold mb-2">Possible Reasons:</div>
              <ul className="text-gray-400 text-sm space-y-1 list-disc list-inside">
          ...
          >
            <div className="space-y-4 text-gray-300">
              <p>
                A security.txt file is a standard way for programs to communicate security policies,
                vulnerability disclosure procedures, and contact information for security researchers.
              </p>
              <div>
                <h5 className="text-red-400 font-semibold mb-2">TYPICAL CONTENTS:</h5>
                <ul className="space-y-1 list-disc list-inside">
              ...
              <p>
                Having a security.txt demonstrates a program's commitment to security and provides
                a clear channel for reporting vulnerabilities.
              </p>
            </div>
          </ExpandableSection>
        </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        {isImmutable && (
          <div className="flex items-center gap-2 px-3 py-2 bg-green-900/20 border border-green-800/50 rounded-lg">
            ...
            <span className="text-green-400 text-sm font-medium uppercase">Immutable</span>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="text-white text-lg font-semibold mb-2">
              This program is {isImmutable ? "immutable" : "upgradeable"} and {isImmutable ? "cannot" : "can"} be upgraded
            </h4>
      ...
      >
        <div className="space-y-4 text-gray-300">
          <div>
            <h5 className="text-red-400 font-semibold mb-2">IMMUTABLE PROGRAMS:</h5>
            <p className="mb-2">
              An immutable program cannot be modified after deployment. The upgrade authority has been
              permanently revoked, providing strong guarantees that the code cannot change.
            </p>
            <ul className="space-y-1 list-disc list-inside">
              <li>
              ...
              <li>
                <strong>Tradeoff:</strong> Bugs cannot be fixed; new deployment required
              </li>
            </ul>
          </div>
          <div>
            <h5 className="text-red-400 font-semibold mb-2">UPGRADEABLE PROGRAMS:</h5>
            <p className="mb-2">
              An upgradeable program can be modified by the upgrade authority, allowing bug fixes and
              improvements but requiring trust in the authority holder.
            </p>
            <ul className="space-y-1 list-disc list-inside">
              <li>
              ...
              <li>
                <strong>Risk:</strong> Authority holder can make malicious changes
              </li>
            </ul>
          </div>
        </div>
