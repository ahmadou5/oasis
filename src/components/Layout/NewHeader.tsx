...
export const NewHearder: React.FC<NewHeaderProps> = ({ setMobileMenuOpen }) => {
  ...
  return (
    <>
      {/* Header - Fixed */}
      <header className="sticky top-0 z-30 backdrop-blur-xl border-b border-gray-200/20 dark:border-gray-700/20 bg-white/5 dark:bg-gray-900/80">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="hidden md:flex relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 w-48 lg:w-64 transition"
                />
              </div>
