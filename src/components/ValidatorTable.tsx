...
export function ValidatorTable({ validators, onValidatorSelect }: ValidatorTableProps) {
          ...
          <tbody>
            {sortedValidators.map((validator, index) => (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        <span className={clsx('w-2 h-2 rounded-full', getStatusColor(validator.status))}></span>
                        <span className="text-solana-gray-400 capitalize">{validator.status}</span>
                        {validator.website && (
                          <a
                ...
                <td className="p-4">
                  <div>
                    <div className="font-medium">{formatSOL(validator.stake)}</div>
